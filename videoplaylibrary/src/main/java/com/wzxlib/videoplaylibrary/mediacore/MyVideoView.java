...
import com.wzxlib.videoplaylibrary.mediacontrol.IMyMediaPlayerControler;
    ...
    public boolean onInfo(IMediaPlayer iMediaPlayer, int i, int i1) {
        ...
        switch (i) {
            ...
            case IMediaPlayer.MEDIA_INFO_BUFFERING_START:
                if (mMyVideoPlayerListener != null) {
                    mMyVideoPlayerListener.onBufferStart();
                }
                break;
            case IMediaPlayer.MEDIA_INFO_BUFFERING_END:
                if (mMyVideoPlayerListener != null) {
                    mMyVideoPlayerListener.onBufferEnd();
                }
                break;
...
//        LogHelper.d("mymediacontor", "percent = " + mCurrentBufferPercentage);
        if (mMyVideoPlayerListener != null) {
